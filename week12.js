...
const makeOne = () => {
	const num1 = 5;
	const num2 = 10;
	resultOne.innerHTML = num1 + num2;//Ваш код
};
...
const makeTwo = () => {
	const num1 = 20;
	const num2 = 7;
	resultTwo.innerHTML = num1 - num2;//Ваш код
};
...
const makeThree = () => {
	const num1 = 8;
	const num2 = 4;
	resultThree.innerHTML = num1 * num2;//Ваш код
};
...
const makeFour = () => {
	const num1 = 16;
	const num2 = 2;
	resultFour.innerHTML = num1 / num2;//Ваш код
};
...
const makeFive = () => {
	const num = 3;
	const power = 4;
	resultFive.innerHTML = Math.pow(num, power);//Ваш код
};
...
const makeSix = () => {
	const num1 = 20;
	const num2 = 5;
	resultSix.innerHTML = num1 % num2;//Ваш код
};
...
const makeSeven = () => {
	const num1 = 25;
	const num2 = 7;
	resultSeven.innerHTML = num1 % num2;//Ваш код
};
...
const makeEight = () => {
	const num1 = 123;
	resultEight.innerHTML = num1 % 10;//Ваш код
};
...
const makeNine = () => {
	const num1 = 4567;
	resultNine.innerHTML = num1 % 100;//Ваш код
};
...
const makeTen = () => {
	const str = 'Hello';
	resultTen.innerHTML = str[2];//Ваш код
};
...
const makeEleven = () => {
	const num1 = 5;
	const num2 = 2;
	resultEleven.innerHTML = num1 % num2;//Ваш код
};
...
const makeTwelve = () => {
	const str1 = 'Hello, ';
	const str2 = 'World!';
	resultTwelve.innerHTML = str1 + str2;//Ваш код
};
...
const makeThirteen = () => {
	...
	resultThirteen.innerHTML = str.length;//Ваш код
};
...
const makeFourteen = () => {
	const str = 'JavaScript';
	resultFourteen.innerHTML = str.toLowerCase();//Ваш код
};
...
const makeFifteen = () => {
	const str = 'JavaScript';
	resultFifteen.innerHTML = str.toUpperCase();//Ваш код
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	resultSixteen.innerHTML = str.substring(3);//Ваш код
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	resultSeventeen.innerHTML = str.substring(3, 7);//Ваш код
};
...
const makeEighteen = () => {
	...
	resultEighteen.innerHTML = str.replace("world", "JavaScript");//Ваш код
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	resultNineteen.innerHTML = str.substr(7, 6);//Ваш код
};
...
const makeTwenty = () => {
	resultTwenty.innerHTML = Math.max(10, 25, 5, 30, 15);//Ваш код
};
...
const makeTwentyOne = () => {
	const min = 1;
	const max = 10;
	resultTwentyOne.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min;//Ваш код
};
...
const makeTwentyTwo = () => {
	resultTwentyTwo.innerHTML = Math.min(10, 25, 5, 30, 15);//Ваш код
};
...
const makeTwentyThree = () => {
	resultTwentyThree.innerHTML = Math.pow(2, 5);//Ваш код
};
...
const makeTwentyFour = () => {
	resultTwentyFour.innerHTML = Math.min(7, 3, 11, 5, 9);//Ваш код
};
...
const makeTwentyFive = () => {
	resultTwentyFive.innerHTML = Math.max(7, 3, 11, 5, 9);//Ваш код
};
...
const makeTwentySix = () => {
	resultTwentySix.innerHTML = Math.random().toFixed(4);//Ваш код
};
...
const makeTwentySeven = () => {
	const min = 50;
	const max = 100;
	resultTwentySeven.innerHTML = Math.floor(Math.random() * (max - min + 1)) + min;//Ваш код
};
...
const makeTwentyEight = () => {
	resultTwentyEight.innerHTML = Math.ceil(4.47);//Ваш код
};
...
const makeTwentyNine = () => {
	resultTwentyNine.innerHTML = Math.sqrt(16);//Ваш код
};
...
const makeThirty = () => {
	resultThirty.innerHTML = Math.sqrt(25);//Ваш код
};
